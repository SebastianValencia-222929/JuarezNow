                        ...
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap gap-3">
                                    <span><i class="fas fa-circle text-danger"></i> Accidente</span>
                                    <span><i class="fas fa-circle text-info"></i> Inundación</span>
                                    <span><i class="fas fa-circle text-warning"></i> Tráfico</span>
